...
jQuery(function($) {
    ...
    ULTRA_SETTINGS.windowBasedLayout = function() {
        ...
        if ($("body").hasClass("chat-open") || $("body").hasClass("sidebar-collapse")) {
            ...
            if ($(".page-topbar").length > 0 && $(".page-sidebar").length > 0 && $("#main-content").length > 0) {
                // Apply the changes only if the elements exist
    ...
    ULTRA_SETTINGS.chatApiScroll = function() {
        ...
        if (currentPath !== "/Login" && currentPath !== "/Supplier/Login") {
